...
namespace LMS.Infractructure.Migrations
{
    ...
    [Migration("20260413122559_AddEnableUploadToActivities")]
    partial class AddEnableUploadToActivities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Models.Entities.Attachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Models.Entities.Attachment", b =>
                {
                    ...
                    b.HasOne("Domain.Models.Entities.ApplicationUser", "UploadedByUser")
                        .WithMany()
